...
export class V11686143387318 implements MigrationInterface {
    name = 'V11686143387318'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`roleHasPermission\` (\`id\` int NOT NULL AUTO_INCREMENT, \`roleId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
