...
export class V11686015807815 implements MigrationInterface {
    name = 'V11686015807815'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`userId\` varchar(36) NOT NULL, \`userEmail\` varchar(255) NOT NULL, \`userPassword\` varchar(255) NOT NULL, \`userPhone\` varchar(255) NOT NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`isAdmin\` tinyint NOT NULL DEFAULT 0, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, UNIQUE INDEX \`IDX_9047b2d58f91586f14f0cf44a4\` (\`userEmail\`), PRIMARY KEY (\`userId\`)) ENGINE=InnoDB`);
